...
async def testDevice(device):
    ...
    print ("Humidity is {0} out of 100".format(device.humidity))
    print ("Light is {0} out of 10".format(device.light))
    print ("Moisture is {0} out of 10".format(device.moisture))
